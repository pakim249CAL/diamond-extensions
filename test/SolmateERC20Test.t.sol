...
contract SolmateERC20Test is TestSetup, DSTestPlus {
  IERC20 token;
  ...
  function testTransferFrom(
    ...
    hevm.assume(to != address(0));
    hevm.assume(approval <= 1e50);
    hevm.assume(amount <= 1e50);
...
contract ERC20Invariants is TestSetup, DSTestPlus, DSInvariantTest {
